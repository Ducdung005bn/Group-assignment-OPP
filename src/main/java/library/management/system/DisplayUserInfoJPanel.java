...
public class DisplayUserInfoJPanel extends javax.swing.JPanel {
    ...
    public DisplayUserInfoJPanel(Borrower borrower, boolean isDealingWithBorrower) {
        initComponents();
        DisplayUserInfoController controller = new DisplayUserInfoController(jpnUserInfo, jpnHistory, borrower, isDealingWithBorrower);
    }
    
    public DisplayUserInfoJPanel(Librarian librarian, boolean isDealingWithBorrower) {
        initComponents();
        DisplayUserInfoController controller = new DisplayUserInfoController(jpnUserInfo, jpnHistory, librarian, isDealingWithBorrower);
    }
