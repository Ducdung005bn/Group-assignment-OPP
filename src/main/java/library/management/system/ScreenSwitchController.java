...
public class ScreenSwitchController {
    ...
    public void setView(JPanel jpn, JLabel jlb) {
        ...
        if (isDealingWithBorrower) {
            root.add(new MainInterfaceJPanel(borrower, libraryManagementSystem));
        } else {
            root.add(new MainInterfaceJPanel(librarian, libraryManagementSystem));
        }
    ...
    class LabelEvent implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (isDealingWithBorrower) {
                switch (kind) {
                    case "MainInterface":
                        node = new MainInterfaceJPanel(borrower, libraryManagementSystem);
                        break;
                    case "FindDocument":
                    ...
                    case "DisplayUserInfo":
                        node = new DisplayUserInfoJPanel(borrower, libraryManagementSystem);
                        break;
                    default:
                        break;
                }
                ...
                switch (kind) {
                    case "MainInterface":
                        node = new MainInterfaceJPanel(librarian, libraryManagementSystem);
                        break;
                    case "FindDocument":
                        node = new FindDocumentJPanel(libraryManagementSystem);
                        break;
                    ...
                    case "AddLibrarian":
                        ...
                        break;
                    case "DisplayUserInfo":
                        node = new DisplayUserInfoJPanel(librarian, libraryManagementSystem);
                        break;
                    default:
                        break;
                }
