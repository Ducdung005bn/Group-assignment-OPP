...
public class Document implements Serializable {
    ...
    private double documentAverageRating;
    private int documentRatingsCount;
    ...
    public Document() {
        ...
        documentGoogleLink = "";
        documentImageUrl = "";
        documentAverageRating = 0.0;
        documentRatingsCount = 0;
    }
    ...
    public double getDocumentAverageRating() {
        return documentAverageRating;
    }

    public void setDocumentAverageRating(double documentAverageRating) {
        this.documentAverageRating = documentAverageRating;
    }

    public int getDocumentRatingsCount() {
        return documentRatingsCount;
    }

    public void setDocumentRatingsCount(int documentRatingsCount) {
        this.documentRatingsCount = documentRatingsCount;
    }
}
