...
public class DisplayUserInfoJPanel extends javax.swing.JPanel {
    ...
    public DisplayUserInfoJPanel(Borrower borrower, LibraryManagementSystem libraryManagementSystem) {
        initComponents();
        DisplayUserInfoController controller = new DisplayUserInfoController(jpnUserInfo, jpnHistory, borrower, libraryManagementSystem);
    }
    
    public DisplayUserInfoJPanel(Librarian librarian, LibraryManagementSystem libraryManagementSystem) {
        initComponents();
        DisplayUserInfoController controller = new DisplayUserInfoController(jpnUserInfo, jpnHistory, librarian, libraryManagementSystem);
    }
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout jpnBorrowedHistoryLayout = new javax.swing.GroupLayout(jpnHistory);
        jpnHistory.setLayout(jpnBorrowedHistoryLayout);
