...
public class StudentJFrame extends javax.swing.JFrame {
    ...
    public StudentJFrame(PendingUser pendingUser,LibraryManagementSystem libraryManagementSystem) {
        initComponents();
        setTitle("Library Management System");
        
        ScreenSwitchController controller = new ScreenSwitchController(jpnView, pendingUser, libraryManagementSystem);
        ...
        itemList.add(new MenuItem("Exit", jpnExit, jlbExit));
        
        controller.setEvent(itemList);
    ...
    private void initComponents() {
        ...
        jpnExit.setBackground(new java.awt.Color(76, 175, 80));

        jlbExit.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
